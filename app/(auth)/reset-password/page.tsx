      ...
      <div className="min-h-screen flex items-center justify-center bg-void">
        <div className="border border-white/20 p-8 w-full max-w-md">
          ...
          <div className="bg-terminal px-6 py-5 mb-6 border border-black">
            <h2 className="text-xs font-bold text-black tracking-widest">Password Updated</h2>
          </div>
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-void">
      <div className="border border-white/20 p-8 w-full max-w-md">
        ...
        <div className="bg-terminal px-6 py-5 mb-6 border border-black">
          <h2 className="text-xs font-bold text-black tracking-widest">Reset Password</h2>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-xs font-medium text-white/50 mb-1 tracking-widest">New Password</label>
            <input
              type="password"
              value={password}
