...
/**
 * GET /api/connect/meta/accounts?session=<uuid>
 *
 * Returns the list of Meta ad accounts stored in a pending OAuth session.
 */
...
export async function GET(request: Request) {
  ...
  if (error || !session) {
    console.error('[meta/accounts] Session not found:', sessionId, error?.message)
