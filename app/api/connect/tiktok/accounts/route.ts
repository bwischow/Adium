...
/**
 * GET /api/connect/tiktok/accounts?session=<uuid>
 *
 * Returns the list of TikTok Ads accounts stored in a pending OAuth session.
 */
...
export async function GET(request: Request) {
  ...
  if (error || !session) {
    console.error('[tiktok/accounts] Session not found:', sessionId, error?.message)
